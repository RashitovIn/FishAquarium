...
namespace FishAquarium
{
    class World
    {
        ...
        {
            int OptSpeedX = Math.Min(Math.Abs(fish.Target[0] - fish.PosX), fish.Speed);
            int OptSpeedY = Math.Min(Math.Abs(fish.Target[1] - fish.PosY), fish.Speed);
        ...
        private void GetTarget(Entity fish)
        {
            ...
            target[0] = (fish.PosX + Dx * stepX + Width - fish.Body.Width) % (Width - fish.Body.Width);
            target[1] = (fish.PosY + Dy * stepY + Height - fish.Body.Height) % (Height - fish.Body.Height);
            fish.Target = target;
        }
        ...
        public void UpdateWorld(ref List<Entity> worldArr, Entity obj, ref ListBox lb)
        {
            ...
            if (obj.Target[0] == obj.PosX && obj.Target[1] == obj.PosY)
                GetTarget(obj);
